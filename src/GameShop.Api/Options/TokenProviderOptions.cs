...
namespace GameShop.Api.Options
{
    public class TokenProviderOptions
    {
        ...
        /// <summary>
        /// Gets or sets the number of minutes a token is valid.
        /// </summary>
        public double ValidityInMinutes { get; set; } = 5;

        /// <summary>
        /// Set the timespan the token will be valid for (default is 5 min/300 seconds)
        /// </summary>
        public TimeSpan ValidUntil => TimeSpan.FromMinutes(ValidityInMinutes);
        ...
        public DateTime Expiration => IssuedAt.Add(ValidUntil);
        ...
        /// <summary>
        /// The algorithm to use when generating tokens. Default value is HS256.
        /// </summary>
